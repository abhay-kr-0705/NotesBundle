...
// Featured notes data (will be replaced with database data)
const featuredNotes = [
    {
        id: '1',
        ...
        price: 299,
        discountPrice: 199,
        thumbnailUrl: '/images/notes/gate-cse.jpg',
        category: 'GATE',
        rating: 4.8,
        reviews: 234,
        isFeatured: true,
    },
    {
        ...
        description: 'Complete notes for all subjects of BEU 3rd semester CSE branch',
        price: 199,
        discountPrice: null,
        thumbnailUrl: '/images/notes/beu-sem3.jpg',
    ...
    },
    {
        ...
        description: 'All-in-one study material for SSC CGL with PYQs and mock tests',
        price: 0,
        discountPrice: null,
        thumbnailUrl: '/images/notes/ssc-cgl.jpg',
    ...
    },
    {
        ...
        description: 'Beautiful handwritten notes covering Python from basics to advanced',
        price: 149,
        discountPrice: 99,
        thumbnailUrl: '/images/notes/python.jpg',
        category: 'Coding',
        rating: 4.7,
        reviews: 189,
        isFeatured: true,
                            ...
                            >
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-muted-foreground text-sm">({note.reviews} reviews)</span>
                                    </div>
